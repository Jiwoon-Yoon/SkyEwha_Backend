...
api_router.include_router(token.router, prefix="/api/v1/token", tags=["Social Auth"])
api_router.include_router(google_auth.router, prefix="/auth/google", tags=["Social Auth"])
api_router.include_router(google_logout_signout.router, prefix="/auth/google", tags=["Social Auth"])